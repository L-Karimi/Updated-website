...
const PERSONAS = [
  {
    ...
    oneLiner: "Run your entire school from one dashboard. Track everything that matters.",
  ...
  },
  {
    ...
    oneLiner: "Control access, data, and integrations. Keep everything running.",
...
const TESTIMONIALS = [
  {
    ...
    school: "Nairobi",
    quote: "QXP transformed how we manage our school. The time saved on administrative tasks is incredible, and parents love the transparency.",
    rating: 5,
    image: "SM"
  },
  {
    ...
    school: "Nairobi",
    quote: "Implementation was smooth, and the support team is fantastic. Our teachers adapted quickly, and we're seeing real improvements in communication.",
    rating: 5,
    image: "DK"
  },
  {
    ...
    school: "Mombasa",
    quote: "Fee management has never been easier. Parents can pay online, and we have real-time visibility into our finances. A game-changer!",
    rating: 5,
    image: "GA"
  },
];
...
const FAQS = [
  {
    ...
    answer: "QXP supports CBC (Competency-Based Curriculum), 8-4-4, British National Curriculum (BNC), and International Baccalaureate (IBE). We work with official KICD curriculum files and can customize for your school's specific needs."
  },
  {
    question: "How long does implementation take?",
    answer: "Most schools are up and running within 2-4 weeks. We provide comprehensive onboarding, training for staff, and ongoing support to ensure a smooth transition."
  },
  {
    question: "Is my school's data secure?",
    answer: "Absolutely. We use bank-grade encryption, regular security audits, and comply with Kenyan data protection regulations. Each school's data is completely isolated in our multi-tenant architecture."
  },
  {
    question: "Can parents access the system?",
    answer: "Yes! Parents get their own portal to view grades, pay fees, communicate with teachers, and track their child's progress. We also have a mobile app for on-the-go access."
  },
  {
    question: "Do you offer training and support?",
    answer: "Yes. We provide comprehensive training during onboarding, video tutorials, help documentation, and ongoing email/phone/WhatsApp support. We're here when you need us."
  },
  {
    question: "What if we need a custom feature?",
    answer: "We regularly add features based on customer feedback. For enterprise clients and school groups, we offer custom development services. Contact our sales team to discuss your specific needs."
  },
  {
    question: "Can we try before we buy?",
    answer: "Absolutely! Book a demo to see the platform in action, and we can set up a pilot program for your school to test it with a small group before full deployment."
  },
  {
    question: "What's included in the pricing?",
    answer: "Our pricing includes all features (LMS, assessments, communication, finance, library, transport, etc.), onboarding, training, mobile apps, and ongoing support. No hidden fees."
  },
];
...
function getDiscountTier(users: number) {
  return DISCOUNT_TIERS.find(tier => users >= tier.minUsers && users <= tier.maxUsers) || DISCOUNT_TIERS[0];
}
...
function Section({ 
  ...
  return (
    <section id={id} className={cls("mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 py-16 sm:py-24", className)}>
      {title && (
        <motion.header
          initial={{ opacity: 0, y: 20 }}
      ...
      {open && (
        ...
        >
          <div className="px-4 py-3 flex flex-col gap-2">
            {NAV.map((n) => (
              <a key={n.label} href={n.href} className="px-3 py-2 rounded-lg hover:bg-accent" onClick={() => setOpen(false)}>
                {n.label}
              </a>
            ))}
        ...
        <div className="mb-12 pb-12 border-b border-border">
          <div className="max-w-2xl mx-auto text-center">
            ...
            <p className="text-sm text-muted-foreground mb-6">
              Get the latest updates on new features, case studies, and education insights.
            </p>
...
function Home() {
  return (
    <>
        ...
        <div className="grid lg:grid-cols-2 items-center gap-12">
          ...
          >
            ...
            <p className="mt-6 text-lg text-muted-foreground">
              Complete LMS for CBC, 8‑4‑4, BNC & IBE — built for schools, teachers, students and parents.
      ...
      <Section id="personas" title="Who it's for" subtitle="Made for the real day‑to‑day of schools.">
        <motion.div
          variants={staggerContainer}
          initial="initial"
          whileInView="animate"
              ...
              >
                ...
                >
                  <div className="flex items-center justify-between">
                    ...
                    >
                      <ChevronRight className="h-5 w-5 group-hover:translate-x-1 transition" style={{ color: p.colorAccent }} />
                    </div>
                  </div>
                </div>
      ...
      <Section id="features" title="Everything you need" subtitle="Powerful modules to run your school efficiently">
        <motion.div
          variants={staggerContainer}
          initial="initial"
          whileInView="animate"
      ...
      <Section id="cta">
        <Card className="p-12 text-center bg-gradient-to-br from-primary/5 to-primary/10 border-primary/20">
          ...
          <p className="text-muted-foreground mb-8 max-w-2xl mx-auto">
            Join 50+ leading schools already using QXP. Book a personalized demo and see how we can help.
          </p>
...
function SolutionsIndex() {
  return (
    <Section title="Solutions by role" subtitle="See how QXP helps every member of your school community with real platform interfaces.">
      <motion.div
        variants={staggerContainer}
        initial="initial"
        whileInView="animate"
...
function Pricing() {
  ...
  const users = Math.max(0, Number(students) || 0) + Math.max(0, Number(teachers) || 0);
        ...
        <div className="grid lg:grid-cols-2 gap-12 items-start">
          ...
          >
            ...
            <p className="text-muted-foreground text-lg mb-8">
              One plan with everything included. Volume discounts for larger schools.
            </p>
            ...
            <Card className="p-8">
              <div className="flex items-start justify-between gap-6 flex-wrap mb-6">
                <div>
                  ...
                  <p className="text-muted-foreground">Everything you need to run your school.</p>
                </div>
                <div className="text-right">
                  <div className="text-3xl">{formatMoney(PRICE_PER_TERM, CURRENCIES.KES)}</div>
                  <div className="text-sm text-muted-foreground">per term / user</div>
                </div>
              </div>
              ...
              <div className="space-y-2 text-sm">
                {DISCOUNT_TIERS.map((t) => (
                  <div key={t.label} className="flex items-center justify-between">
                    ...
                    <Badge variant={tier.label === t.label ? "default" : "outline"}>
                      {t.discount}% off
                    </Badge>
                  </div>
                ))}
          ...
          >
            <Card className="p-8 sticky top-24">
              ...
              <div className="mt-6 p-6 rounded-xl bg-primary/10 border border-primary/20">
                ...
                <div className="text-4xl">{formatMoney(total, CURRENCIES.KES)}</div>
                {tier.discount > 0 && (
              ...
              <p className="mt-4 text-xs text-muted-foreground text-center">
                * Prices in KES. Taxes may apply. Custom quotes available for 5,000+ users.
              </p>
            </Card>
          </motion.div>
        </div>
...
function Contact() {
  ...
  const [formData, setFormData] = useState(() => loadFormData('contact') || {
    name: '',
    email: '',
    school: '',
    phone: '',
  ...
  return (
    <Section title="Get in touch" subtitle="We'll respond within 1 business day.">
      <div className="grid lg:grid-cols-3 gap-8 max-w-6xl mx-auto">
        ...
        >
          <Card className="p-6">
            ...
            <a href="mailto:hello@qxp.global" className="text-sm text-muted-foreground hover:text-foreground">
              hello@qxp.global
            </a>
          </Card>
          ...
          <Card className="p-6">
            ...
            <a href="https://wa.me/254700779977" target="_blank" rel="noreferrer" className="text-sm text-muted-foreground hover:text-foreground">
              +254 700 779 977
            </a>
          </Card>
...
function Demo() {
  const [submitted, setSubmitted] = useState(false);
  const [formData, setFormData] = useState(() => loadFormData('demo') || {
    name: '',
    email: '',
    school: '',
    role: '',
  ...
  const handleSubmit = (e: React.FormEvent) => {
    ...
    setTimeout(() => {
      setSubmitted(false);
      setFormData({ name: '', email: '', school: '', role: '', date: '', time: '', notes: '' });
    }, 4000);
  };

  return (
    <Section title="Book a demo" subtitle="See QXP in action with a personalized 20-minute walkthrough.">
...
function About() {
  return (
    <>
      <Section title="About QXP" subtitle="Building the future of education in Kenya and beyond.">
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          ...
          >
            ...
            <p className="text-muted-foreground mb-6">
              We're on a mission to empower schools across Kenya with world-class technology that makes education
              more accessible, efficient, and effective. Every school deserves the tools to succeed.
            </p>
            <h3 className="text-2xl mb-4">What we believe</h3>
            <ul className="space-y-3 text-muted-foreground">
              <li className="flex items-start gap-2">
                <CheckCircle2 className="h-5 w-5 text-primary flex-shrink-0 mt-0.5" />
                <span>Technology should empower educators, not replace them</span>
              </li>
              <li className="flex items-start gap-2">
                <CheckCircle2 className="h-5 w-5 text-primary flex-shrink-0 mt-0.5" />
              ...
              <li className="flex items-start gap-2">
                <CheckCircle2 className="h-5 w-5 text-primary flex-shrink-0 mt-0.5" />
                <span>Parents should have visibility into their child's progress</span>
              </li>
              <li className="flex items-start gap-2">
                <CheckCircle2 className="h-5 w-5 text-primary flex-shrink-0 mt-0.5" />
      ...
      <Section>
        <Card className="p-12 text-center bg-gradient-to-br from-primary/5 to-primary/10 border-primary/20">
          ...
          <p className="text-muted-foreground mb-8 max-w-2xl mx-auto">
            We're always looking for talented people who are passionate about education technology.
          </p>
          <Button asChild size="lg">
...
function Testimonials() {
  return (
    <Section title="What schools say about us" subtitle="Real feedback from real educators using QXP every day.">
      <motion.div
        variants={staggerContainer}
        initial="initial"
        whileInView="animate"
      ...
      <div className="mt-16 text-center">
        <Card className="p-8 bg-gradient-to-br from-primary/5 to-primary/10 border-primary/20 inline-block">
          ...
          <div className="text-sm text-muted-foreground mb-6">Average rating from 50+ schools</div>
          <Button asChild>
            <a href="#/marketing/demo">
...
function FAQ() {
  return (
    <Section title="Frequently asked questions" subtitle="Everything you need to know about QXP.">
      <div className="max-w-3xl mx-auto">
        ...
        <Card className="p-8 mt-12 text-center">
          ...
          <p className="text-muted-foreground mb-6">
            Our team is here to help. Reach out and we'll get back to you within 1 business day.
          </p>
...
function Careers() {
  ...
  return (
    <>
      <Section title="Join our team" subtitle="Help us build the future of education in Kenya.">
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          <motion.div
            initial={{ opacity: 0, x: -20 }}
            animate={{ opacity: 1, x: 0 }}
          ...
          >
            <Card className="p-8 bg-gradient-to-br from-primary/5 to-primary/10">
              ...
              <p className="text-sm text-muted-foreground mb-6">
                Join a fast-growing team that's transforming how schools operate across Kenya.
              </p>
      ...
      <Section title="Open positions" className="bg-muted/30">
        ...
        <div className="mt-12 text-center">
          <p className="text-muted-foreground mb-4">
            Don't see a role that fits? We're always interested in talented people.
          </p>
          <Button asChild variant="outline">
      ...
      <div className="max-w-3xl mx-auto">
        <Card className="p-8">
          <div className="prose prose-sm max-w-none">
            ...
            <p className="text-muted-foreground mb-6">
              This is a placeholder for your {title.toLowerCase()}. Replace this content with your actual legal documentation.
            </p>

            <h3 className="text-xl mb-4">Our Commitment</h3>
            <ul className="list-disc pl-6 text-muted-foreground space-y-2 mb-6">
              <li>We respect data privacy and comply with Kenyan data protection regulations</li>
              <li>We use bank-grade encryption to protect your school's data</li>
              <li>We're transparent about how we collect, use, and store information</li>
              <li>We follow WCAG 2.2 AA accessibility guidelines</li>
              <li>We're committed to providing excellent service and support</li>
            </ul>

            <h3 className="text-xl mb-4">Questions?</h3>
            <p className="text-muted-foreground mb-4">
              If you have any questions about our {title.toLowerCase()}, please contact us:
            </p>
            <div className="flex flex-col gap-2 text-sm">
              <a href="mailto:legal@qxp.global" className="text-primary hover:underline">
                legal@qxp.global
              </a>
              <a href="#/marketing/contact" className="text-primary hover:underline">
                Contact form
              </a>
            </div>
          </div>
...
export default function MarketingWebsite() {
  ...
  const parts = useMemo(() => route.split("?")[0].split("/").filter(Boolean), [route]);

  let page = <Home />;
  if (parts[0] === "solutions" && !parts[1]) page = <SolutionsIndex />;
  if (parts[0] === "solutions" && parts[1]) page = <PersonaPage slug={parts[1]} />;
  ...
  if (parts.length > 0 && page === <Home /> && parts[0] !== "") page = <NotFound />;
